...
Item {
    ...
    Column
    {
        ...
        width: parent.width - (highlightItemSvg.margins.left + highlightItemSvg.margins.right)
        ...
        PlasmaComponents3.Label {
            ...
            // ELIMINAMOS los anchors.top: icon.bottom, la Column lo hace sola
            anchors.horizontalCenter: parent.horizontalCenter
            width: parent.width
            ...
            // Mantenemos tu fuente impecable
    ...
    // ... resto de tu código abajo (ToolTip, Keys, etc) ...
