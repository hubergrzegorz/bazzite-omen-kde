...
FocusScope {
    ...
    implicitHeight: gridView.contentHeight > 0 ? gridView.contentHeight : 100
    ...
    function tryActivate(row, col)
    {
        if (count)
        {
            ...
            focus = true;
            rootItem.contador_rep++;

            console.log("solicitud de activate no: "+rootItem.contador_rep +" para Fila solicitada:", row, "Columna solicitada:", col);
        }
    }
